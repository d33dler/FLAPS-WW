...
public class FetchUtils {
	 ...
	 */
	private static final Map<Class<?>, Function<Object, Object>> customDeserializers = new HashMap<>();
	 ...
	 */
	private static boolean isFieldPrimitiveDeserializable(Field field) {
	 ...
	 */
	private static Object getPrimitiveFieldValue(Field field, String expectedColumnName, ResultSet rs) {
		try {
