...
public class SimulationUtils {
    ...
    public static void customFlyToFly(FlightSimApplication simApp, Position location, long flightTime) {
        simApp.getOrbitView().addPitchAnimator(simApp.getOrbitView().getPitch(), Angle.NEG90);
        schedule(execServ,() -> animatedPanBack(simApp.getOrbitView(), simApp,0.1),2000);
       ...
       schedule(execServ, () -> {
        ...
        schedule(execServ, () -> {
            ...
            Position pos = tempFly.getCurrentEyePosition();
